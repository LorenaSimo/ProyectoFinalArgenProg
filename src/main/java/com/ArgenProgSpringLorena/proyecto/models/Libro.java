package com.ArgenProgSpringLorena.proyecto.models;
...
public class Libro {
	...
	public Libro(Integer libroId, Long isbn, String titulo, Integer anio, Integer ejemplares,
	...
	public String toString() {
		return "Libro [libroId=" + libroId + ", isbn=" + isbn + ", titulo=" + titulo + ", anio=" + anio
